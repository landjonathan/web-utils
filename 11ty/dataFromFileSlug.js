/**
 * {@link} https://gist.github.com/robdodson/c2d3c4a6bf6bf9962893760c5585a3eb
 */
 ...
 * @return {Object[]} The original collection. We return this to make
...
module.exports = (eleventyConfig, pluginNamespace) => {
  eleventyConfig.namespace(pluginNamespace, () => {
    eleventyConfig.addCollection('memoized', collection => memoize(collection.getAll()))

    eleventyConfig.addFilter('dataFromFileSlug', string => dataFromFileSlug(string).data)
  })
}